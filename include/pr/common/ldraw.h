...
namespace pr::ldraw
{
	...
	struct EKeywords
	{
		...
		inline static constexpr NameValue BaseColourTexture = {"*BaseColourTexture", 1020105447};
		...
		inline static constexpr NameValue EmissiveTexture = {"*EmissiveTexture", 2593342865};
		...
		inline static constexpr NameValue MetallicTexture = {"*MetallicTexture", 1827337475};
		...
		inline static constexpr NameValue NormalTexture = {"*NormalTexture", 2206230309};
		...
		inline static constexpr NameValue RoughnessTexture = {"*RoughnessTexture", 1537835364};
