...
namespace pr::rdr12::ldraw
{
	...
	std::string AutoCompleteTemplates()
	{
		...
		str.append(""
			...
			"*Circle [<name>] [<colour>]\n"
			"{\n"
			"	(*Data {<radius> | <radiusx> <radiusy> | <radius> <cx> <cy> | <radiusx> <radiusy> <cx> <cy>})\n"
			"	[*Facets {<facet_count>}]\n"
			"	[@AxisId]\n"
			"	[@Solid]\n"
			"	[@Texture]\n"
			...
			"*Pie [<name>] [<colour>]\n"
			"{\n"
			"	(*Data {<angle0> <angle1> <inner_radius> <outer_radius> [<cx> <cy>]})\n"
			"	[*Facets {<facet_count>}]\n"
			"	[*Scale {<sx> <sy>}]\n"
			"	[@AxisId]\n"
			"	[@Solid]\n"
			...
			"*Rect [<name>] [<colour>]\n"
			"{\n"
			"	(*Data {<width> | <width> <height> | <width> <cx> <cy> | <width> <height> <cx> <cy>})\n"
			"	[*CornerRadius {<radius>}]\n"
			"	[*Facets {<facet_count>}]\n"
			"	[@AxisId]\n"
			"	[@Solid]\n"
			...
			"	&Recursive\n"
			"}\n"
			"*SphereList [<name>] [<colour>]\n"
			"{\n"
			"	[@PerItemColour]\n"
			"	*Data {(<rx> <ry> <rz> <x> <y> <z> [<colour>])}\n"
			"	[*Facets {<divisions>}]\n"
			"	[@Texture]\n"
			"	$ObjectModifiers\n"
			"	&Recursive\n"
