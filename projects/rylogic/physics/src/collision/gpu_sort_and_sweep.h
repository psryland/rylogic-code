...
namespace pr::physics
{
	...
	private:
		...
		D3DPtr<ID3D12Resource> m_r_dispatch;  // GPU buffer: RWStructuredBuffer<D3D12_DISPATCH_ARGUMENTS> for indirect dispatch of the collision shader based on the number of pairs generated by the sweep.
