...
namespace pr::physics
{
	struct GpuCollisionDetector
	{
		...
		void DetectCollisions(GpuJob& job, int max_contacts, D3DPtr<ID3D12Resource> dispatch, D3DPtr<ID3D12Resource> pairs, D3DPtr<ID3D12Resource> counters, CollisionShapeCache const& shape_cache);
		int DetectCollisions(GpuJob& job, std::span<GpuCollisionPair const> pairs, CollisionShapeCache const& shape_cache, std::span<GpuContact> contacts);
